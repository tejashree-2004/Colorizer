...
## Overview
Colorizer is a system for running and deploying large language models (LLMs) efficiently across different platforms. It enables applications to perform real-time LLM inference locally or on servers without relying entirely on external cloud APIs.
...
## Installation
```bash
git clone https://github.com/tejashree-2004/colorizer.git
cd colorizer
